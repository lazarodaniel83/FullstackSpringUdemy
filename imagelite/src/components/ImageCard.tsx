...
export const ImageCard: React.FC<ImageCardProps> = ({
    nome, dataUpload, src, tamanho}: ImageCardProps
    ) => {
    return(
        <div className="card reative bg-white rounded-md transition-transform ease-in duration-300 transfor hover:shadow-lg hover:translate-y-2">
